      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md flex justify-between items-center px-4 py-4 border-b border-gray-100 relative">
        ...
        <div className="relative z-10 flex items-center gap-2.5">
          <a 
            ...
            className="flex items-center gap-2 bg-brand-primary border border-transparent text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full hover:bg-brand-secondary hover:shadow-[0_4px_12px_rgba(168,32,26,0.25)] transition-all duration-200 whitespace-nowrap shadow-sm"
          >
